...
public class ProductService : IProductService
{
    ...
    {
        await _httpClient.PostAsJsonAsync<CreateProductDto>("catalog/products", createProductDto);
    }

    public async Task DeleteProductAsync(string id)
    {
        await _httpClient.DeleteAsync("catalog/products?id=" + id);
    }

    public async Task<List<ResultProductDto>> GetAllProductAsync()
    {
        HttpResponseMessage responseMessage = await _httpClient.GetAsync("catalog/products");
    ...
    {
        HttpResponseMessage responseMessage = await _httpClient.GetAsync("catalog/products/withrelationships");
    ...
    {
        HttpResponseMessage responseMessage = await _httpClient.GetAsync("catalog/products/withrelationshipsbycategoryid?categoryId=" + categoryId);
    ...
    {
        HttpResponseMessage responseMessage = await _httpClient.GetAsync("catalog/products/" + id);
    ...
    {
        await _httpClient.PutAsJsonAsync<UpdateProductDto>("catalog/products", updateProductDto);
    }
