...
public class ProductDetailService : IProductDetailService
{
    ...
    {
        await _httpClient.PostAsJsonAsync<CreateProductDetailDto>("catalog/productdetails", createProductDetailDto);
    }

    public async Task DeleteProductDetailAsync(string id)
    {
        await _httpClient.DeleteAsync("catalog/productdetails?id=" + id);
    }

    public async Task<List<ResultProductDetailDto>> GetAllProductDetailAsync()
    {
        HttpResponseMessage responseMessage = await _httpClient.GetAsync("catalog/productdetails");
    ...
    {
        HttpResponseMessage responseMessage = await _httpClient.GetAsync("catalog/productdetails/" + id);
    ...
    {
        HttpResponseMessage responseMessage = await _httpClient.GetAsync("catalog/productdetails/getwithrelationshipsbyproductid?productId=" + productId);
    ...
    {
        await _httpClient.PutAsJsonAsync<UpdateProductDetailDto>("catalog/productdetails", updateProductDetailDto);
    }
}
